  ...
  Widget build(BuildContext context) {
    ...
    return (Scaffold(
      appBar: AppBar(
        ...
        title: Text("MSM SUITE", style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),),
      ),
      body:SingleChildScrollView(
         ...
         SizedBox(height: 10.0,),
          ...
          Container(
            ...
            width: 500,
          child:Center(child:
          LoginColumn(user: user, password: password)),
        ),
          ClipPath(
            ...
            child: Container(
              ...
              child: SizedBox(
                child: Center(
                    child: 
                    Text("Dejando una linda huella en cada una de nuestras acciones",
            ...
            SizedBox(
                ...
                child: Padding(
                    ...
                    child: FloatingActionButton.extended(
                      ...
                      label: Text("Ingresar",style: TextStyle(color: kPrimaryColor,fontWeight: FontWeight.bold),),
                      icon: Icon(Icons.login_rounded,color: kPrimaryColor,),
                      elevation: 20,
                    )))
          ],
        );
